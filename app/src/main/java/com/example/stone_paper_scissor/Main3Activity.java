...
public class Main3Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView = (TextView) findViewById(R.id._3_player2_name);
        textView.setText(player2);

        bt_0 = (Button) findViewById(R.id.p2_2turn_0);
        bt_1 = (Button) findViewById(R.id.p2_2turn_1);
        bt_2 = (Button) findViewById(R.id.p2_2turn_2);
